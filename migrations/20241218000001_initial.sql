-- Initial database schema for agentic-rust
...
-- Document chunks table (optional - can also use vector DB only)
...
VALUES (
    ...
    'gpt-4',
    'You are a helpful AI assistant. You provide accurate, helpful, and concise responses to user questions. When you have access to context documents, use them to inform your answers. If you don''t know something, say so honestly.',
    0.7,
    5,
    '[]'
